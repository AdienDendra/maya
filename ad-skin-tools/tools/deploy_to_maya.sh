...
required_files=(
    ...
    "$PACKAGE_SRC/bind_smoothing/v7_blocking_smoothing.py"
...
rm -f \
    ...
    "$SCRIPT_DST_DIR/test_v61_bind_smoothing_constraints.py" \
    "$SCRIPT_DST_DIR/test_v61b_owner_and_ties.py" \
    "$SCRIPT_DST_DIR/test_v61c_bind_skin_color_feedback.py" \
