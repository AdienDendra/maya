"""Compact Maya-centric UI for AD Skin Tool v5.0."""
...
from ad_skin_tools.v5 import object_region_rebind
...
def install(tool_window_module) -> None:
    """Install v4 behaviour, then replace only the operation UI with v5."""
    ...
    tool_window_module._V50_OBJECT_REGION_UI_INSTALLED = True
...
def apply_add_influence() -> None:
    ...
    try:
        ...
        builtins.AD_SKIN_V50_ADD_INFLUENCE_RESULT = result
